...
{
    [[NSNotificationCenter defaultCenter]postNotificationName:notification.alertAction object:self userInfo:notification.userInfo];
}
...
{
    /// TODO Check if device is running task, if not send availability to master
}
